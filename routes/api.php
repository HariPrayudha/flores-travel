...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/supir-exports/items', [ExportPenerimaanController::class, 'index']);
    Route::post('/supir-exports/items/mark-received', [ExportPenerimaanController::class, 'markReceived']);
});
